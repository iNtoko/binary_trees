...
/**
 * tree_height - measurs the height of a binary tree
...
/**
 * tree_size_h - measurs the sum of the heights of the binary tree
...
/**
 * _preorder - goes through the binary tree using pre-order traversal
