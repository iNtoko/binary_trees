...
/**
 * heap_insert - inserts the value in Max Binary Heap
...
heap_t *heap_insert(heap_t **root, int value)
{
	...
	/*
	 * Traverse tree to first empty slot based on a binary
	 * representation of the numbr of leaves.
	 * Example -
	...
	/* Flip values with parent untl parent value exceeds new value */
 ...
 * @tree: tree to measre the size of
 *
